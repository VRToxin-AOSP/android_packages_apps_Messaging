...
public class QMessageBubbleBackground extends LinearLayout {
    private final  int mSnapWidthPixels;

    public QMessageBubbleBackground(Context context, AttributeSet attrs) {
        super(context, attrs);
        mSnapWidthPixels = context.getResources().getDimensionPixelSize(
                R.dimen.qm_conversation_bubble_width_snap);
    }
